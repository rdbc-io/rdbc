...
import io.rdbc.sapi.{AnyParametrizedStatement, ParametrizedInsert, Timeout}

import scala.concurrent.Future

class ParametrizedInsertImpl(stmt: AnyParametrizedStatement) extends ParametrizedInsert {
