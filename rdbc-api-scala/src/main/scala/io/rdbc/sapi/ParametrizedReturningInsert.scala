...
trait ParametrizedReturningInsert extends ParametrizedInsert {
  ...
  /** Executes an insert statement and returns generated key rows as
    ...
    * $baseExceptions
    */
  def executeForKeysStream()(implicit timeout: Timeout): Future[ResultStream]
  ...
  /** Executes an insert statement and returns generated key rows as
    ...
    * $baseExceptions
    */
  def executeForKeysSet()(implicit timeout: Timeout): Future[ResultSet]
  ...
  /** Executes an insert statement and returns a single generated Int key.
    ...
    * $keyExceptions
    */
  def executeForIntKey()(implicit timeout: Timeout): Future[Int]
  ...
  /** Executes an insert statement and returns a single generated Long key.
    ...
    * $keyExceptions
    */
  def executeForLongKey()(implicit timeout: Timeout): Future[Long]
  ...
  /** Executes an insert statement and returns a single generated UUID key.
    ...
    * $keyExceptions
    */
  def executeForUUIDKey()(implicit timeout: Timeout): Future[UUID]
}
